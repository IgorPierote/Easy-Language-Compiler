...
public class EasyLanguageLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "TIPO_NUMERO", "TIPO_TEXTO", "TIPO_BOOLEANO", 
			"TIPO_VOID", "FUNCAO_KW", "PROCEDIMENTO_KW", "RETORNO_KW", "NAO_KW", 
			"FACA_KW", "AP", "AC", "FC", "FP", "SC", "OP", "ATTR", "VIR", "ACH", 
			"FCH", "DP", "OPBOOL", "STRING_LITERAL", "BOOLEANO", "OPREL", "ID", "NUMBER", 
			"COMMENT", "WS"
		};
	}
